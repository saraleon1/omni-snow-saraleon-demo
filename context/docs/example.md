...
Do not use `stg_order_items` or `stg_products` for reporting — those are staging tables. Always use the production `dbt_sleon_prod` views. some change another change and another
